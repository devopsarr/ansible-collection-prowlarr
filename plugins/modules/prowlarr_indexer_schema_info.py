...
DOCUMENTATION = r'''
---
module: prowlarr_indexer_schema_info

short_description: Get information about Prowlarr indexer schema.

version_added: "1.0.0"

description: Get information about Prowlarr indexer schema.
