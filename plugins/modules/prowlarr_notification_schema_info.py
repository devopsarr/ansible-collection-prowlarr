...
DOCUMENTATION = r'''
---
module: prowlarr_notification_schema_info

short_description: Get information about Prowlarr notification schema.

version_added: "1.0.0"

description: Get information about Prowlarr notification schema.
