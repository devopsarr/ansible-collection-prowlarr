...
DOCUMENTATION = r'''
---
module: prowlarr_indexer

short_description: Manages Prowlarr indexer.

version_added: "1.0.0"

description: Manages Prowlarr indexer.
...
def is_changed(status, want):
    if (want.name != status.name or
            ...
            want.app_profile_id != status.app_profile_id or
...
def init_module_args():
    ...
    return dict(
        ...
        app_profile_id=dict(type='int', default=0),
...
def run_module():
    ...
    client = prowlarr.IndexerApi(module.api)
    result = dict(
        changed=False,
        id=0,
    )
    ...
    # Set wanted resource.
    want = prowlarr.IndexerResource(
        name=module.params['name'],
        enable=module.params['enable'],
        priority=module.params['priority'],
        app_profile_id=module.params['app_profile_id'],
